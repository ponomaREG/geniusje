            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.level_23:
                        ...
                        break;
                    case R.id.level_24:
                        startActivity(new Intent(LevelsActivity.this, Level_24.class));
                        break;
                    case R.id.level_25:
                        startActivity(new Intent(LevelsActivity.this, Level_25.class));
                        break;
                    case R.id.level_26:
                        startActivity(new Intent(LevelsActivity.this, Level_26.class));
                        break;
                    case R.id.level_27:
                    ...
                    case R.id.level_29:
                        ...
                        break;
                    case R.id.level_30:
                        startActivity(new Intent(LevelsActivity.this, Level_30.class));
                        break;
                }
            }
        };
