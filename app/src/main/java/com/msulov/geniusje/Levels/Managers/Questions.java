...
public class Questions {
    ...
    private static String[][][] answers = {
            {
                    ...
                    {"отношение гипотенузы к прилежащему катету","отношение противолежащего катека к прилежащему","отношение прилежащего катета к противолежащему","отношение противолежащего катета к гипотенузе"},
    ...
    public static String[][] getRandomData(int type){
        ...
        answers = Memory_game.getShakedArray(answers.clone());
