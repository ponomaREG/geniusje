    ...
    public void startResultsDialog() {
        ...
        View.OnClickListener OnClickListener = v -> {
            if (v.getId() == R.id.repeatResultsDialog) {
                if(isWin) {
                    startActivity(new Intent(getApplicationContext(), Level_2.class)); //REPEAT
                }else{
                ...
                Intent intent;// = null;
                if(isWin) {
                    intent = new Intent(getApplicationContext(),Level_3.class);
                }else{
                    intent = new Intent(getApplicationContext(), Level_2.class); //REPEAT
                }
